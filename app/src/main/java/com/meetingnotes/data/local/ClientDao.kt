...
interface ClientDao {
    ...
    @Query("UPDATE clients SET leadSource = :leadSource, referredBy = :referredBy WHERE id = :clientId")
    suspend fun updateLeadInfo(clientId: Long, leadSource: String?, referredBy: String?)
