...
interface ClientDao {
    ...
    @Query("UPDATE clients SET name = :name, email = :email, phone = :phone WHERE id = :clientId")
    suspend fun updateInfo(clientId: Long, name: String, email: String?, phone: String?)
