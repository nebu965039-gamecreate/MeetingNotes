...
### STEP 3. グラフィック素材を用意する(画像。別途作成が必要)
- [ ] アプリアイコン 512×512 PNG(現在 AGP テンプレート。差し替え推奨)
- [ ] フィーチャーグラフィック 1024×500 PNG/JPG
- [ ] スクリーンショット 2〜8枚(推奨: 録音画面 / 要約結果 / クライアント一覧 / エクスポートメニュー)
  - エミュレータまたは実機で撮影。`adb exec-out screencap -p > shot.png`
